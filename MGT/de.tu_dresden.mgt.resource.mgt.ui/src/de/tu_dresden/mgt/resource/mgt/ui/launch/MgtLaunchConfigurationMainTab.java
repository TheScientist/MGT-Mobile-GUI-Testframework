 ...
 * class.
 */
public class MgtLaunchConfigurationMainTab extends org.eclipse.debug.ui.AbstractLaunchConfigurationTab {
	...
	public void createControl(org.eclipse.swt.widgets.Composite parent) {
		...
		propertiesLabel = new org.eclipse.swt.widgets.Label(group, org.eclipse.swt.SWT.NONE);
		propertiesLabel.setText("Properties:");
		gd = new org.eclipse.swt.layout.GridData();
		propertiesLabel.setLayoutData(gd);
		
		propertiesBox = new Text(group, SWT.MULTI | SWT.BORDER | SWT.V_SCROLL);
		propertiesBox.setLayoutData(new org.eclipse.swt.layout.GridData(org.eclipse.swt.layout.GridData.FILL_BOTH));
		propertiesBox.addModifyListener(new org.eclipse.swt.events.ModifyListener() {
			public void modifyText(org.eclipse.swt.events.ModifyEvent evt) {
				updateLaunchConfigurationDialog();
			}
		});		
		...
		gd.verticalAlignment = SWT.FILL;
		gd.horizontalSpan = 2;
		propertiesBox.setLayoutData(gd);
	...
	public void initializeFrom(org.eclipse.debug.core.ILaunchConfiguration configuration) {
		try {
			uriText.setText(configuration.getAttribute(de.tu_dresden.mgt.resource.mgt.launch.MgtLaunchConfigurationDelegate.ATTR_RESOURCE_URI, ""));
			propertiesBox.setText(configuration.getAttribute(de.tu_dresden.mgt.resource.mgt.launch.MgtLaunchConfigurationDelegate.ATTR_RESOURCE_PROPS, ""));
			// more initialization code can be added here
		} catch (org.eclipse.core.runtime.CoreException e) {
			de.tu_dresden.mgt.resource.mgt.mopp.MgtPlugin.logError("Can't initialize launch configuration tab.", e);
		}
	}
	
	public void performApply(org.eclipse.debug.core.ILaunchConfigurationWorkingCopy configuration) {
		configuration.setAttribute(de.tu_dresden.mgt.resource.mgt.launch.MgtLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uriText.getText());
		configuration.setAttribute(de.tu_dresden.mgt.resource.mgt.launch.MgtLaunchConfigurationDelegate.ATTR_RESOURCE_PROPS, propertiesBox.getText());
	}
	...
	public org.eclipse.swt.graphics.Image getImage() {
		return de.tu_dresden.mgt.resource.mgt.ui.MgtImageProvider.INSTANCE.getImage("icons/launch_tab_main_icon.gif");
	}
	...
	protected void handleBrowseWorkspace() {
		...
		dialog.addFilter(new org.eclipse.jface.viewers.ViewerFilter() {
			...
			public boolean select(org.eclipse.jface.viewers.Viewer viewer, Object parentElement, Object element) {
				if (element instanceof org.eclipse.core.resources.IFile) {
					...
					return file.getFileExtension().equals(new de.tu_dresden.mgt.resource.mgt.mopp.MgtMetaInformation().getSyntaxName());
				}
				return true;
			}
		});
		...
		dialog.setValidator(new org.eclipse.ui.dialogs.ISelectionStatusValidator() {
			public org.eclipse.core.runtime.IStatus validate(Object[] selection) {
				if (selection.length > 0 && selection[0] instanceof org.eclipse.core.resources.IFile)				return new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.OK, de.tu_dresden.mgt.resource.mgt.ui.MgtUIPlugin.PLUGIN_ID, org.eclipse.core.runtime.IStatus.OK, "", null);
				
				return new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, de.tu_dresden.mgt.resource.mgt.ui.MgtUIPlugin.PLUGIN_ID, org.eclipse.core.runtime.IStatus.ERROR, "", null);
			}
		});
