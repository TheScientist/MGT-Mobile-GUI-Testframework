 ...
 * 
 */
package de.tu_dresden.mgt.resource.mgt.ui.debug;

@SuppressWarnings("restriction")
public class MgtAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new de.tu_dresden.mgt.resource.mgt.mopp.MgtMetaInformation().getSyntaxName())) {
					return new de.tu_dresden.mgt.resource.mgt.ui.debug.MgtLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof de.tu_dresden.mgt.resource.mgt.debug.MgtDebugVariable) {
			final de.tu_dresden.mgt.resource.mgt.debug.MgtDebugVariable variable = (de.tu_dresden.mgt.resource.mgt.debug.MgtDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof de.tu_dresden.mgt.resource.mgt.debug.MgtDebugVariable) {
			final de.tu_dresden.mgt.resource.mgt.debug.MgtDebugVariable variable = (de.tu_dresden.mgt.resource.mgt.debug.MgtDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							de.tu_dresden.mgt.resource.mgt.debug.MgtDebugValue castedValue = (de.tu_dresden.mgt.resource.mgt.debug.MgtDebugValue) value;
