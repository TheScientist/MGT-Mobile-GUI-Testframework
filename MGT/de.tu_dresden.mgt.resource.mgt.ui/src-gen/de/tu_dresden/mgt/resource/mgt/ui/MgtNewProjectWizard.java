 ...
 */
public class MgtNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new de.tu_dresden.mgt.resource.mgt.mopp.MgtMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("de.tu_dresden.mgt.resource.mgt.ui");
							...
							String natureID = de.tu_dresden.mgt.resource.mgt.mopp.MgtNature.NATURE_ID;
							...
							for (String builderID : de.tu_dresden.mgt.resource.mgt.mopp.MgtNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								de.tu_dresden.mgt.resource.mgt.mopp.MgtMetaInformation info = new de.tu_dresden.mgt.resource.mgt.mopp.MgtMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = de.tu_dresden.mgt.resource.mgt.ui.MgtUIPlugin.getDefault().getBundle();
