...
public class MgtNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private de.tu_dresden.mgt.resource.mgt.ui.MgtNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public MgtNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new de.tu_dresden.mgt.resource.mgt.ui.MgtNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			de.tu_dresden.mgt.resource.mgt.ui.MgtUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			de.tu_dresden.mgt.resource.mgt.ui.MgtUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new de.tu_dresden.mgt.resource.mgt.mopp.MgtMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new de.tu_dresden.mgt.resource.mgt.mopp.MgtMetaInformation().getSyntaxName();
	}
	
	public de.tu_dresden.mgt.resource.mgt.IMgtMetaInformation getMetaInformation() {
