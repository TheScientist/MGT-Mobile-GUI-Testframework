 ...
 */
public class MgtCodeFoldingManager {
	
	private class FoldingUpdateListener implements de.tu_dresden.mgt.resource.mgt.IMgtBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(de.tu_dresden.mgt.resource.mgt.ui.MgtEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof de.tu_dresden.mgt.resource.mgt.ui.MgtEditor) {
				de.tu_dresden.mgt.resource.mgt.ui.MgtEditor editor = (de.tu_dresden.mgt.resource.mgt.ui.MgtEditor) workbenchPart;
	...
	protected de.tu_dresden.mgt.resource.mgt.ui.MgtEditor editor;
	 ...
	 */
	public MgtCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,de.tu_dresden.mgt.resource.mgt.ui.MgtEditor textEditor) {
	...
	private void addCloseListener(final de.tu_dresden.mgt.resource.mgt.ui.MgtEditor editor) {
	...
	protected void calculatePositions() {
		de.tu_dresden.mgt.resource.mgt.IMgtTextResource textResource = (de.tu_dresden.mgt.resource.mgt.IMgtTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
