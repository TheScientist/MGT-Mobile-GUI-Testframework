...
public class MgtLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(de.tu_dresden.mgt.resource.mgt.mopp.MgtPlugin.DEBUG_MODEL_ID);
			...
			de.tu_dresden.mgt.resource.mgt.debug.MgtLineBreakpoint lineBreakpoint = new de.tu_dresden.mgt.resource.mgt.debug.MgtLineBreakpoint(resource, lineNumber + 1);
