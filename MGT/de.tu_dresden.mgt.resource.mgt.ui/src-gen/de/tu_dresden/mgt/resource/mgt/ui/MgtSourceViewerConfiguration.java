 ...
 */
public class MgtSourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	 ...
	 */
	public MgtSourceViewerConfiguration(de.tu_dresden.mgt.resource.mgt.IMgtResourceProvider resourceProvider, de.tu_dresden.mgt.resource.mgt.ui.IMgtAnnotationModelProvider annotationModelProvider, de.tu_dresden.mgt.resource.mgt.ui.IMgtBracketHandlerProvider bracketHandlerProvider, de.tu_dresden.mgt.resource.mgt.ui.MgtColorManager colorManager) {
		super(de.tu_dresden.mgt.resource.mgt.ui.MgtUIPlugin.getDefault().getPreferenceStore());
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new de.tu_dresden.mgt.resource.mgt.ui.MgtIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
