 ...
 */
public class MgtUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "de.tu_dresden.mgt.resource.mgt.ui";
	public static final String EDITOR_ID = "de.tu_dresden.mgt.resource.mgt.ui.MgtEditor";
	...
	private static MgtUIPlugin plugin;
	...
	public static MgtUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, MgtUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, MgtUIPlugin.PLUGIN_ID, message);
		}
		final MgtUIPlugin pluginInstance = MgtUIPlugin.getDefault();
