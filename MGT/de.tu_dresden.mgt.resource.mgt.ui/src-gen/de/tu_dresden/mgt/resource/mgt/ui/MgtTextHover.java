 ...
 */
public class MgtTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private de.tu_dresden.mgt.resource.mgt.IMgtHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final de.tu_dresden.mgt.resource.mgt.ui.MgtBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(de.tu_dresden.mgt.resource.mgt.ui.MgtBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			de.tu_dresden.mgt.resource.mgt.ui.MgtDocBrowserInformationControlInput infoInput = (de.tu_dresden.mgt.resource.mgt.ui.MgtDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					de.tu_dresden.mgt.resource.mgt.ui.MgtHyperlink hyperlink = new de.tu_dresden.mgt.resource.mgt.ui.MgtHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (de.tu_dresden.mgt.resource.mgt.ui.MgtBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				de.tu_dresden.mgt.resource.mgt.ui.MgtBrowserInformationControl iControl = new de.tu_dresden.mgt.resource.mgt.ui.MgtBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof de.tu_dresden.mgt.resource.mgt.ui.MgtDocBrowserInformationControlInput) {
							de.tu_dresden.mgt.resource.mgt.ui.MgtDocBrowserInformationControlInput input = (de.tu_dresden.mgt.resource.mgt.ui.MgtDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (de.tu_dresden.mgt.resource.mgt.ui.MgtBrowserInformationControl.isAvailable(parent)) {
				de.tu_dresden.mgt.resource.mgt.ui.MgtBrowserInformationControl iControl = new de.tu_dresden.mgt.resource.mgt.ui.MgtBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public MgtTextHover(de.tu_dresden.mgt.resource.mgt.IMgtResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new de.tu_dresden.mgt.resource.mgt.ui.MgtUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((de.tu_dresden.mgt.resource.mgt.ui.MgtDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private de.tu_dresden.mgt.resource.mgt.ui.MgtDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private de.tu_dresden.mgt.resource.mgt.ui.MgtDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, de.tu_dresden.mgt.resource.mgt.ui.MgtDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				de.tu_dresden.mgt.resource.mgt.ui.MgtHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			de.tu_dresden.mgt.resource.mgt.ui.MgtHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			de.tu_dresden.mgt.resource.mgt.ui.MgtHTMLPrinter.insertPageProlog(buffer, 0, de.tu_dresden.mgt.resource.mgt.ui.MgtTextHover.getStyleSheet());
			de.tu_dresden.mgt.resource.mgt.ui.MgtHTMLPrinter.addPageEpilog(buffer);
			return new de.tu_dresden.mgt.resource.mgt.ui.MgtDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = de.tu_dresden.mgt.resource.mgt.ui.MgtHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(de.tu_dresden.mgt.resource.mgt.ui.MgtUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return de.tu_dresden.mgt.resource.mgt.util.MgtStreamUtil.getContent(styleSheetURL.openStream());
