...
public class MgtSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = de.tu_dresden.mgt.resource.mgt.ui.MgtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.tu_dresden.mgt.resource.mgt.ui.MgtSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = de.tu_dresden.mgt.resource.mgt.ui.MgtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.tu_dresden.mgt.resource.mgt.ui.MgtSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = de.tu_dresden.mgt.resource.mgt.ui.MgtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.tu_dresden.mgt.resource.mgt.ui.MgtSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = de.tu_dresden.mgt.resource.mgt.ui.MgtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.tu_dresden.mgt.resource.mgt.ui.MgtSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = de.tu_dresden.mgt.resource.mgt.ui.MgtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.tu_dresden.mgt.resource.mgt.ui.MgtSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = de.tu_dresden.mgt.resource.mgt.ui.MgtSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.tu_dresden.mgt.resource.mgt.ui.MgtSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		de.tu_dresden.mgt.resource.mgt.ui.MgtPixelConverter pixelConverter = new de.tu_dresden.mgt.resource.mgt.ui.MgtPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof de.tu_dresden.mgt.resource.mgt.ui.MgtEditor) {
			de.tu_dresden.mgt.resource.mgt.ui.MgtEditor emfTextEditor = (de.tu_dresden.mgt.resource.mgt.ui.MgtEditor) editor;
