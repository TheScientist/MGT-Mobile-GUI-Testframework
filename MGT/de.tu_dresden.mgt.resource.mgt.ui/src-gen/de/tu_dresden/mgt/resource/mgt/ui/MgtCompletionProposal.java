 ...
 */
public class MgtCompletionProposal implements java.lang.Comparable<MgtCompletionProposal> {
	 ...
	 */
	private de.tu_dresden.mgt.resource.mgt.mopp.MgtExpectedTerminal expectedTerminal;
	...
	public MgtCompletionProposal(de.tu_dresden.mgt.resource.mgt.mopp.MgtExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public MgtCompletionProposal(de.tu_dresden.mgt.resource.mgt.mopp.MgtExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public MgtCompletionProposal(de.tu_dresden.mgt.resource.mgt.mopp.MgtExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public de.tu_dresden.mgt.resource.mgt.mopp.MgtExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof MgtCompletionProposal) {
			MgtCompletionProposal other = (MgtCompletionProposal) object;
	...
	public int compareTo(MgtCompletionProposal object) {
		if (object instanceof MgtCompletionProposal) {
			MgtCompletionProposal other = (MgtCompletionProposal) object;
