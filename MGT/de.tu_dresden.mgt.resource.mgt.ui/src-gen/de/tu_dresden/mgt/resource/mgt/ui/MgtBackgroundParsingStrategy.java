 ...
 */
public class MgtBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final de.tu_dresden.mgt.resource.mgt.IMgtTextResource resource, final de.tu_dresden.mgt.resource.mgt.ui.MgtEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final de.tu_dresden.mgt.resource.mgt.IMgtTextResource resource, final de.tu_dresden.mgt.resource.mgt.ui.MgtEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final de.tu_dresden.mgt.resource.mgt.IMgtTextResource resource, final de.tu_dresden.mgt.resource.mgt.ui.MgtEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof de.tu_dresden.mgt.resource.mgt.mopp.MgtResource) {
							de.tu_dresden.mgt.resource.mgt.mopp.MgtResource concreteResource = (de.tu_dresden.mgt.resource.mgt.mopp.MgtResource) resource;
