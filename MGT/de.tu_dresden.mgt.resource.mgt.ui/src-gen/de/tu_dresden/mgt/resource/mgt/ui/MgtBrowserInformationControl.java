 ...
 * @since 3.2
 */
public class MgtBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private de.tu_dresden.mgt.resource.mgt.ui.MgtDocBrowserInformationControlInput fInput;
	 ...
	 */
	public MgtBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public MgtBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public MgtBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof de.tu_dresden.mgt.resource.mgt.ui.MgtDocBrowserInformationControlInput);
		...
		fInput= (de.tu_dresden.mgt.resource.mgt.ui.MgtDocBrowserInformationControlInput) input;
		...
		de.tu_dresden.mgt.resource.mgt.ui.MgtHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = de.tu_dresden.mgt.resource.mgt.ui.MgtHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public de.tu_dresden.mgt.resource.mgt.ui.MgtDocBrowserInformationControlInput getInput() {
		return fInput;
	}
