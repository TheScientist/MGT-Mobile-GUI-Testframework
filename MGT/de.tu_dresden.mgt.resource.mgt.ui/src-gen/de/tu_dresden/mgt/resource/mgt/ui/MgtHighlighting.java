 ...
 */
public class MgtHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static de.tu_dresden.mgt.resource.mgt.ui.MgtPositionHelper positionHelper = new de.tu_dresden.mgt.resource.mgt.ui.MgtPositionHelper();
	...
	private de.tu_dresden.mgt.resource.mgt.ui.MgtTokenScanner scanner;
	...
	private de.tu_dresden.mgt.resource.mgt.ui.MgtEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private de.tu_dresden.mgt.resource.mgt.ui.MgtOccurrence occurrence;
	private de.tu_dresden.mgt.resource.mgt.ui.MgtBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, de.tu_dresden.mgt.resource.mgt.IMgtBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public MgtHighlighting(de.tu_dresden.mgt.resource.mgt.IMgtTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, de.tu_dresden.mgt.resource.mgt.ui.MgtColorManager colorManager, de.tu_dresden.mgt.resource.mgt.ui.MgtEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = de.tu_dresden.mgt.resource.mgt.ui.MgtUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new de.tu_dresden.mgt.resource.mgt.ui.MgtTokenScanner(textResource, colorManager);
		occurrence = new de.tu_dresden.mgt.resource.mgt.ui.MgtOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new de.tu_dresden.mgt.resource.mgt.ui.MgtBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(de.tu_dresden.mgt.resource.mgt.ui.MgtPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, de.tu_dresden.mgt.resource.mgt.ui.MgtPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(de.tu_dresden.mgt.resource.mgt.ui.MgtEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, de.tu_dresden.mgt.resource.mgt.ui.MgtPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, de.tu_dresden.mgt.resource.mgt.ui.MgtPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(de.tu_dresden.mgt.resource.mgt.ui.MgtPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new de.tu_dresden.mgt.resource.mgt.ui.MgtEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
