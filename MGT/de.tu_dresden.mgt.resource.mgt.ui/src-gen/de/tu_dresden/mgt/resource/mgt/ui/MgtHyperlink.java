 ...
 */
public class MgtHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public MgtHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				de.tu_dresden.mgt.resource.mgt.mopp.MgtPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
