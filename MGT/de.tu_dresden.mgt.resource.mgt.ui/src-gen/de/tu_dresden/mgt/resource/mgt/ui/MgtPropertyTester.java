...
public class MgtPropertyTester extends org.eclipse.core.expressions.PropertyTester {
	...
	private boolean hasMatchingURI(org.eclipse.core.resources.IResource resource) {
		...
		return path.endsWith("." + new de.tu_dresden.mgt.resource.mgt.mopp.MgtMetaInformation().getSyntaxName());
	}
