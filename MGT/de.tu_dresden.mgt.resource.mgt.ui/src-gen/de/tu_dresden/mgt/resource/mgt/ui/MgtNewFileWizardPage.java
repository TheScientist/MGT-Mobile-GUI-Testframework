 ...
 */
public class MgtNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public MgtNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new mgt file");
