 ...
 * olInput</code>.
 */
public class MgtDocBrowserInformationControlInput {
	
	private final MgtDocBrowserInformationControlInput fPrevious;
	private MgtDocBrowserInformationControlInput fNext;
	 ...
	 */
	public MgtDocBrowserInformationControlInput(MgtDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public MgtDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public MgtDocBrowserInformationControlInput getNext() {
		return fNext;
	}
