...
public class MgtBracketSet {
	...
	private java.util.ArrayList<de.tu_dresden.mgt.resource.mgt.IMgtBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements de.tu_dresden.mgt.resource.mgt.IMgtBracketPair {
	 ...
	 */
	private class ClosingListener implements de.tu_dresden.mgt.resource.mgt.ui.IMgtBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				de.tu_dresden.mgt.resource.mgt.IMgtBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public MgtBracketSet(de.tu_dresden.mgt.resource.mgt.ui.MgtEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new de.tu_dresden.mgt.resource.mgt.mopp.MgtMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<de.tu_dresden.mgt.resource.mgt.IMgtBracketPair>();
	 ...
	 */
	public de.tu_dresden.mgt.resource.mgt.IMgtBracketPair getBracketPair(String opening, String closing) {
		for (de.tu_dresden.mgt.resource.mgt.IMgtBracketPair bracketPair : bracketPairs) {
	...
	public de.tu_dresden.mgt.resource.mgt.IMgtBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(de.tu_dresden.mgt.resource.mgt.IMgtBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + de.tu_dresden.mgt.resource.mgt.ui.MgtPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public de.tu_dresden.mgt.resource.mgt.IMgtBracketPair remove(String opening, String closing) {
		for (de.tu_dresden.mgt.resource.mgt.IMgtBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<de.tu_dresden.mgt.resource.mgt.IMgtBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, de.tu_dresden.mgt.resource.mgt.ui.MgtPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, de.tu_dresden.mgt.resource.mgt.ui.MgtPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
