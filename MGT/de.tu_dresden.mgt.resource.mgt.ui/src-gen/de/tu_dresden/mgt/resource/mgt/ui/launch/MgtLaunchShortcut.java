 ...
 */
public class MgtLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new de.tu_dresden.mgt.resource.mgt.mopp.MgtMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(de.tu_dresden.mgt.resource.mgt.launch.MgtLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			de.tu_dresden.mgt.resource.mgt.mopp.MgtPlugin.logError("Exception while launching selection", e);
		}
	}
