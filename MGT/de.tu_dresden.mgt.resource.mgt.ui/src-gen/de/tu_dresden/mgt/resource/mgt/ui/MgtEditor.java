...
public class MgtEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, de.tu_dresden.mgt.resource.mgt.IMgtResourceProvider, de.tu_dresden.mgt.resource.mgt.ui.IMgtBracketHandlerProvider, de.tu_dresden.mgt.resource.mgt.ui.IMgtAnnotationModelProvider {
	...
	private de.tu_dresden.mgt.resource.mgt.ui.MgtHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private de.tu_dresden.mgt.resource.mgt.ui.MgtCodeFoldingManager codeFoldingManager;
	private de.tu_dresden.mgt.resource.mgt.ui.MgtBackgroundParsingStrategy bgParsingStrategy = new de.tu_dresden.mgt.resource.mgt.ui.MgtBackgroundParsingStrategy();
	private java.util.Collection<de.tu_dresden.mgt.resource.mgt.IMgtBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<de.tu_dresden.mgt.resource.mgt.IMgtBackgroundParsingListener>();
	private de.tu_dresden.mgt.resource.mgt.ui.MgtColorManager colorManager = new de.tu_dresden.mgt.resource.mgt.ui.MgtColorManager();
	private de.tu_dresden.mgt.resource.mgt.ui.MgtOutlinePage outlinePage;
	...
	private de.tu_dresden.mgt.resource.mgt.ui.MgtPropertySheetPage propertySheetPage;
	...
	private de.tu_dresden.mgt.resource.mgt.ui.IMgtBracketHandler bracketHandler;
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), MgtEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								de.tu_dresden.mgt.resource.mgt.IMgtTextResource currentResource = getResource();
				...
				de.tu_dresden.mgt.resource.mgt.ui.MgtUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("de.tu_dresden.mgt.resource.mgt.EditorContext");
		setRulerContextMenuId("de.tu_dresden.mgt.resource.mgt.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new de.tu_dresden.mgt.resource.mgt.ui.MgtHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new de.tu_dresden.mgt.resource.mgt.ui.MgtCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		de.tu_dresden.mgt.resource.mgt.mopp.MgtNature.activate(inputFile.getProject());
		...
		de.tu_dresden.mgt.resource.mgt.IMgtTextResource loadedResource = (de.tu_dresden.mgt.resource.mgt.IMgtTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				de.tu_dresden.mgt.resource.mgt.IMgtTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof de.tu_dresden.mgt.resource.mgt.IMgtTextResource) {
					setResource((de.tu_dresden.mgt.resource.mgt.IMgtTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					de.tu_dresden.mgt.resource.mgt.ui.MgtUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the MgtEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				de.tu_dresden.mgt.resource.mgt.ui.MgtUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(de.tu_dresden.mgt.resource.mgt.IMgtTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new de.tu_dresden.mgt.resource.mgt.ui.MgtOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new de.tu_dresden.mgt.resource.mgt.ui.MgtPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			de.tu_dresden.mgt.resource.mgt.IMgtTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				de.tu_dresden.mgt.resource.mgt.IMgtTextToken token = lexer.getNextToken();
			...
			de.tu_dresden.mgt.resource.mgt.ui.MgtUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!MgtEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(de.tu_dresden.mgt.resource.mgt.IMgtBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (de.tu_dresden.mgt.resource.mgt.IMgtBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public de.tu_dresden.mgt.resource.mgt.ui.IMgtBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(de.tu_dresden.mgt.resource.mgt.ui.IMgtBracketHandler bracketHandler) {
