...
public class MgtRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			de.tu_dresden.mgt.resource.mgt.mopp.MgtPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			de.tu_dresden.mgt.resource.mgt.mopp.MgtPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
