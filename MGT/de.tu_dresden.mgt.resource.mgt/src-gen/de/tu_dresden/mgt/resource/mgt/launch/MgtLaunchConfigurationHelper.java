 ...
 * delegates.
 */
public class MgtLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends de.tu_dresden.mgt.resource.mgt.util.AbstractMgtInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, de.tu_dresden.mgt.resource.mgt.util.AbstractMgtInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final de.tu_dresden.mgt.resource.mgt.debug.MgtDebuggableInterpreter<ResultType, ContextType> interpreter = new de.tu_dresden.mgt.resource.mgt.debug.MgtDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		de.tu_dresden.mgt.resource.mgt.debug.MgtDebuggerListener<ResultType, ContextType> debugListener = new de.tu_dresden.mgt.resource.mgt.debug.MgtDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		de.tu_dresden.mgt.resource.mgt.debug.MgtDebugProcess process = new de.tu_dresden.mgt.resource.mgt.debug.MgtDebugProcess(launch);
		launch.addDebugTarget(new de.tu_dresden.mgt.resource.mgt.debug.MgtDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(de.tu_dresden.mgt.resource.mgt.launch.MgtLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return de.tu_dresden.mgt.resource.mgt.util.MgtResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, de.tu_dresden.mgt.resource.mgt.mopp.MgtPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
