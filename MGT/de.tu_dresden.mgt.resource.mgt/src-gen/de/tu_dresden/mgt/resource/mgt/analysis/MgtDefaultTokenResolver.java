 ...
 */
public class MgtDefaultTokenResolver implements de.tu_dresden.mgt.resource.mgt.IMgtTokenResolver {
	 ...
	 */
	public MgtDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public MgtDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, de.tu_dresden.mgt.resource.mgt.IMgtTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : de.tu_dresden.mgt.resource.mgt.grammar.MgtGrammarInformationProvider.INSTANCE.getKeywords()) {
