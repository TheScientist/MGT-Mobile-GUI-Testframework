 ...
 */
public interface IMgtOptions {
	
	/**
	 * The key for the option to provide a stream pre-processor.
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new de.tu_dresden.mgt.resource.mgt.mopp.MgtMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new de.tu_dresden.mgt.resource.mgt.mopp.MgtMetaInformation().getResourcePostProcessorProviderOptionKey();
