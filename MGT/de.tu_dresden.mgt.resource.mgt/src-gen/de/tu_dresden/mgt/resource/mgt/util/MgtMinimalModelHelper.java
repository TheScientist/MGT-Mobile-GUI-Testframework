 ...
 */
public class MgtMinimalModelHelper {
	
	private final static de.tu_dresden.mgt.resource.mgt.util.MgtEClassUtil eClassUtil = new de.tu_dresden.mgt.resource.mgt.util.MgtEClassUtil();
			...
			if (feature instanceof org.eclipse.emf.ecore.EReference) {
				...
				if (type instanceof org.eclipse.emf.ecore.EClass) {
					...
					for (int i = 0; i < lowerBound; i++) {
						...
						if (reference.isContainment()) {
							...
							String initialValue = "#some" + de.tu_dresden.mgt.resource.mgt.util.MgtStringUtil.capitalize(typeClass.getName());
						...
						if (value instanceof java.util.List<?>) {
							java.util.List<org.eclipse.emf.ecore.EObject> list = de.tu_dresden.mgt.resource.mgt.util.MgtListUtil.castListUnchecked(value);
							list.add(subModel);
						} else {
				...
				if ("EString".equals(attribute.getEType().getName())) {
					...
					if (attribute.getName().equals("name") && name != null) {
						...
						initialValue = "some" + de.tu_dresden.mgt.resource.mgt.util.MgtStringUtil.capitalize(attribute.getName());
					}
					Object value = root.eGet(attribute);
					if (value instanceof java.util.List<?>) {
						java.util.List<String> list = de.tu_dresden.mgt.resource.mgt.util.MgtListUtil.castListUnchecked(value);
