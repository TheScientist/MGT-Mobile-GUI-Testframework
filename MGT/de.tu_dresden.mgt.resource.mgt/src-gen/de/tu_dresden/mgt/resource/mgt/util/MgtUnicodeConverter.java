 ...
 * to 4 bytes).
 */
public class MgtUnicodeConverter extends de.tu_dresden.mgt.resource.mgt.mopp.MgtInputStreamProcessor {
	 ...
	 */
	public MgtUnicodeConverter(java.io.InputStream inputStream) {
