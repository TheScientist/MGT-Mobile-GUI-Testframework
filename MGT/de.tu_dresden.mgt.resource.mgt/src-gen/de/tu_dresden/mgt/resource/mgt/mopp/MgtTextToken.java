...
public class MgtTextToken implements de.tu_dresden.mgt.resource.mgt.IMgtTextToken {
	
	private final de.tu_dresden.mgt.resource.mgt.IMgtMetaInformation metaInformation = new de.tu_dresden.mgt.resource.mgt.mopp.MgtMetaInformation();
	private final org.antlr.runtime3_3_0.Token antlrToken;
	
	public MgtTextToken(org.antlr.runtime3_3_0.Token antlrToken) {
		super();
