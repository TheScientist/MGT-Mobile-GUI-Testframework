 ...
 */
public class MgtPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "de.tu_dresden.mgt.resource.mgt";
	/**
	...
	private static MgtPlugin plugin;
	...
	public static MgtPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, MgtPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, MgtPlugin.PLUGIN_ID, message);
		}
		final MgtPlugin pluginInstance = MgtPlugin.getDefault();
