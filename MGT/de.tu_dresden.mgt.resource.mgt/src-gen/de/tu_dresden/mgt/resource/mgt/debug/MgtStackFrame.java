...
public class MgtStackFrame extends de.tu_dresden.mgt.resource.mgt.debug.MgtDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private de.tu_dresden.mgt.resource.mgt.debug.MgtDebugTarget target;
	private String name;
	private int id;
	...
	public MgtStackFrame(de.tu_dresden.mgt.resource.mgt.debug.MgtDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = de.tu_dresden.mgt.resource.mgt.util.MgtStringUtil.decode(data, ',');
	...
	private de.tu_dresden.mgt.resource.mgt.debug.MgtDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		de.tu_dresden.mgt.resource.mgt.debug.MgtStackFrame other = (de.tu_dresden.mgt.resource.mgt.debug.MgtStackFrame) obj;
		if (name == null) {
