...
/**
 * A IMgtReferenceResolverSwitch holds references to multiple other reference
 * resolvers and delegates requests to the appropriate resolver.
 */
public interface IMgtReferenceResolverSwitch extends de.tu_dresden.mgt.resource.mgt.IMgtConfigurable {
