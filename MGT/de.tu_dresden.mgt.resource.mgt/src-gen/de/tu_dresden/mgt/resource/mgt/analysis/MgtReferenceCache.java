 ...
 * given name.
 */
public class MgtReferenceCache extends org.eclipse.emf.common.notify.impl.AdapterImpl implements de.tu_dresden.mgt.resource.mgt.IMgtReferenceCache {
	...
	private de.tu_dresden.mgt.resource.mgt.IMgtNameProvider nameProvider;
	
	public MgtReferenceCache(de.tu_dresden.mgt.resource.mgt.IMgtNameProvider nameProvider) {
		super();
