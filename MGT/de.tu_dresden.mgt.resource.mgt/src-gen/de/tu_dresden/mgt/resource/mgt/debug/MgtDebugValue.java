...
public class MgtDebugValue extends de.tu_dresden.mgt.resource.mgt.debug.MgtDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public MgtDebugValue(de.tu_dresden.mgt.resource.mgt.debug.MgtDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
