...
public class MgtLayoutUtil {
	...
	public void transferLayoutInformationToModel(org.eclipse.emf.ecore.EObject element) {
		...
		for (java.util.Iterator<de.tu_dresden.mgt.resource.mgt.mopp.MgtLayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			de.tu_dresden.mgt.resource.mgt.mopp.MgtLayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(org.eclipse.emf.ecore.EObject element) {
		...
		if (layoutReference != null) {
			...
			for (java.util.Iterator<org.eclipse.emf.ecore.EObject> i = list.iterator(); i.hasNext(); ) {
				...
				de.tu_dresden.mgt.resource.mgt.mopp.MgtLayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public org.eclipse.emf.ecore.EObject createLayoutInformationModelElement(de.tu_dresden.mgt.resource.mgt.mopp.MgtLayoutInformation layoutInformation, org.eclipse.emf.ecore.EPackage layoutPackage) {
		...
		de.tu_dresden.mgt.resource.mgt.grammar.MgtSyntaxElement syntaxElement = layoutInformation.getSyntaxElement();
		...
		layoutInformationModelElement.eSet(layoutInformationEClass.getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME), de.tu_dresden.mgt.resource.mgt.grammar.MgtGrammarInformationProvider.getSyntaxElementID(syntaxElement));
		return layoutInformationModelElement;
	}
	
	public de.tu_dresden.mgt.resource.mgt.mopp.MgtLayoutInformation createLayoutInformation(org.eclipse.emf.ecore.EObject layoutInformationModelElement) {
		Object object = null;
		...
		de.tu_dresden.mgt.resource.mgt.grammar.MgtSyntaxElement syntaxElement = de.tu_dresden.mgt.resource.mgt.grammar.MgtGrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof de.tu_dresden.mgt.resource.mgt.grammar.MgtPlaceholder) {
			de.tu_dresden.mgt.resource.mgt.grammar.MgtPlaceholder placeholder = (de.tu_dresden.mgt.resource.mgt.grammar.MgtPlaceholder) syntaxElement;
			de.tu_dresden.mgt.resource.mgt.IMgtTokenResolver tokenResolver = new de.tu_dresden.mgt.resource.mgt.mopp.MgtTokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			de.tu_dresden.mgt.resource.mgt.IMgtTokenResolveResult result = new de.tu_dresden.mgt.resource.mgt.mopp.MgtTokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new de.tu_dresden.mgt.resource.mgt.mopp.MgtLayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public de.tu_dresden.mgt.resource.mgt.mopp.MgtLayoutInformationAdapter getLayoutInformationAdapter(org.eclipse.emf.ecore.EObject element) {
