...
/**
 * A MgtLayoutInformationAdapter is used to store layout information that is found
 ...
 * MgtLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class MgtLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<de.tu_dresden.mgt.resource.mgt.mopp.MgtLayoutInformation> layoutInformations = new java.util.ArrayList<de.tu_dresden.mgt.resource.mgt.mopp.MgtLayoutInformation>();
	...
	public java.util.List<de.tu_dresden.mgt.resource.mgt.mopp.MgtLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(de.tu_dresden.mgt.resource.mgt.mopp.MgtLayoutInformation layoutInformation) {
